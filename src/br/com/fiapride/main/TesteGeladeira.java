...
public class TesteGeladeira {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Espaço disponível na geladeira pequena: "
                + geladeiraPequena.verificarEspacoDisponivel() + "ml");

        System.out.println("Espaço disponível na geladeira grande: "
                + geladeiraGrande.verificarEspacoDisponivel() + "ml");

        System.out.println("\n### Teste da Regra ###");
        geladeiraPequena.setCapacidadeMaxima(-200);
        geladeiraPequena.exibirStatus();
    }
}
